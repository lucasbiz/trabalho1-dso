...
class ControladorDoador():
    ...
    def __init__(self, controlador_doacao):
        self.__doadores = {11111111111: Doador(11111111111, 'Lucas Doador', '02/05/00', 'Rua Sempre Viva')}
    ...
    def editar_doador(self):
        ...
        if cpf_informado == 1:
            ...
            elif doador_editado[0] not in self.__controlador_doacao.verificar_doadores():
            ...
            elif doador_editado[0] in self.__controlador_doacao.verificar_doadores():
